...
my_hash_table.set_item("nail", 98)
my_hash_table.print_table()
bolts = my_hash_table.get_item("bolts")
print(f"bolts: {bolts}")
washers = my_hash_table.get_item("washers")
print(f"washers: {washers}")
nail = my_hash_table.get_item("nail")
print(f"nail: {nail}")
missing = my_hash_table.get_item("missing")
print(f"missing: {missing}")
lumber = my_hash_table.get_item("lumber")
print(f"lumber: {lumber}")

keys = my_hash_table.get_keys()
print(f"all keys in hash table are: {keys}")
