...
Your function should return a list of tuples, where each tuple contains two integers from arr1 and arr2 
that add up to target. The first element of each tuple should be from arr1 and the second from arr2.
