...
that takes in the input list my_list as a parameter and 
...
The order of the elements in the updated list may be different from 
the original list, as sets are unordered.
"""
